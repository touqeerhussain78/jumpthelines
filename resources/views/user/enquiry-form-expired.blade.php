        ...
        <div class="col-12 my-5">
            <div class="bg-shape" data-aos="zoom-in-left" data-aos-easing="linear" data-aos-duration="600">
                <div id="general-form">
                    ...
                    <div class="status-label red">Status: Expired</div>
                </div>
            </div>
        </div>
        <!-- Service main banner -->
                ...
                <div id="general-form">
                    <div class="row px-md-5 px-3 mt-5 mt-md-0">
                        ...
                        <div class="col-12 text-center">
                            <button type="button" class="btn gold-btn-filled" data-bs-toggle="modal" data-bs-target="#unsuccessfulPayment">Accept and Pay Reject</button>
...
<div class="modal" tabindex="-1" id="unsuccessfulPayment">
      ...
      <div class="bg-shape">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="img/error-cut-icon.png" alt="" class="img-fluid mx-auto">
                <h5>Error! Payment Unsuccessful.</h5>
            </div>
            <div class="modal-footer border-top-0 justify-content-center pb-5">
                <button type="button" class="btn gold-btn-filled" data-bs-dismiss="modal">Try Again</button>
            </div>
        </div>
      </div>
  </div>
