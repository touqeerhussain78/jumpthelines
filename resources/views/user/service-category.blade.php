    ...
    <div class="container">
        <div class="row py-5 align-items-end">
            <div class="col-12 text-left">
                <h2 class="page-banner-title">Service <span class="text-white">Categories</span></h2>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row my-3 pt-5 align-items-center justify-content-between">
        ...
        <div class="col-md-11 text-center">
            <h3 class="dark-heading">Service Categories </h3>
        </div>
            ...
            <form action="">
                <div class="row">
                    <div class="col-md-6 text-center mx-auto">
                        <div class="search">
                            <input type="text" class="searchTerm" placeholder="Search Service Categories here">
        ...
        <div class="col-xl-4 col-md-6 mt-5">
            <div class="category-box" data-aos="zoom-in-down" data-aos-anchor-placement="top-bottom" data-aos-easing="linear" data-aos-duration="800">
                ...
                <div class="category-content">
                    ...
                    <a href="#" class="gold-btn-filled d-inline-block my-4">View</a>
                </div>
            </div>
        </div>
        @endforeach
